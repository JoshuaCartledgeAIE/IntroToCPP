...
Character::Character() : GameObject{{0,0}}, m_healthPoints{0}, m_maxHP{0}, m_attackPoints{0},
m_defendPoints{0}
{
}
...
inline void Character::SetMaxHP(float value) { 
	m_maxHP = value; 
...
inline void Character::SetHP(float value) { 
